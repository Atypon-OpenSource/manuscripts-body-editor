...
export class CaptionTitleNodeView
  ...
  implements ManuscriptNodeView
{
  ...
  public updateContents = () => {
    ...
    this.dom.setAttribute(
      ...
      this.node.attrs.placeholder || 'Title...'
    )
  }

  protected createDOM = () => {
    this.dom = document.createElement('label')
    this.dom.className = 'caption-title'
...
export default createEditableNodeView(CaptionTitleNodeView)
