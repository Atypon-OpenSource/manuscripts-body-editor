...
import plugins from '../plugins/simple-editor'
import views from '../views/simple-editor'
import { EditorBase, EditorBaseProps } from './EditorBase'

export class SimpleEditor extends EditorBase<EditorBaseProps> {
  constructor(props: EditorBaseProps) {
    super(props)
