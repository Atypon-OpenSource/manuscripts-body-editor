...
export default (opts: Options = {}) =>
  (
    ...
    doCommand: (command: Command<ManuscriptSchema>) => boolean
  ): MenuSpec[] => {
    const {
    ...
    const wrap = (cmd: Command<ManuscriptSchema>) => () => doCommand(cmd)
    const isCommandValid = (cmd: Command<ManuscriptSchema>) => cmd(state)
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            active: isCommandValid(blockActive(schema.nodes.link)),
        ...
        submenu: [
          {
            ...
            active: isCommandValid(markActive(schema.marks.bold)),
          ...
          },
          {
            ...
            active: isCommandValid(markActive(schema.marks.italic)),
          ...
          },
          {
            ...
            active: isCommandValid(markActive(schema.marks.strikethrough)),
          ...
          },
          {
            ...
            active: isCommandValid(markActive(schema.marks.underline)),
          ...
          },
          {
            ...
            active: isCommandValid(markActive(schema.marks.superscript)),
          ...
          },
          {
            ...
            active: isCommandValid(markActive(schema.marks.subscript)),
